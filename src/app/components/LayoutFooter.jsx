const LayoutFooter = () => {
  return (
    <footer className="footer bg-base-200 p-10">
      ...
      <div>
        <span className="footer-title">Mis redes</span>
        <div className="grid grid-flow-col gap-4">
          <a href="https://www.instagram.com/danilopgon">
            <svg
              className="w-6 fill-primary transition duration-300 ease-in-out hover:scale-110"
              xmlns="http://www.w3.org/2000/svg"
              fill="currentColor"
          ...
          <a href="https://www.twitter.com/danilopgon">
            <svg
              className="w-6 fill-primary transition duration-300 ease-in-out hover:scale-110"
              xmlns="http://www.w3.org/2000/svg"
              fill="currentColor"
          ...
          <a href="https://www.linkedin.com/in/danilopgon">
            <svg
              className="w-6 fill-primary transition duration-300 ease-in-out hover:scale-110"
              xmlns="http://www.w3.org/2000/svg"
              fill="currentColor"
